...
import img1 from "../assets/day6/1.jpg";
import img2 from "../assets/day6/2.jpg";
import img3 from "../assets/day6/3.jpg";
import img4 from "../assets/day6/4.jpg";
import img5 from "../assets/day6/5.jpg";

export const BlogPost6 = ({ post }) => {
  ...
  const demoPost = post || {
    id: "1",
    title: "Baguio Escapde",
    date: "April 12, 2025",
    category: "Day 6",
    images: [img1, img2, img3, img4, img5],
    content: `<p>We set off for Baguio at 1 am, excited to experience the cool climate and scenic beauty of the Summer Capital of the Philippines. The winding roads and mountain views made the trip feel like a journey into a new world, adding a sense of adventure to our day.</p>

    <br>
    
    <p>Our first stop was the Strawberry Farm, where we enjoyed the fresh air and learned about local agriculture in La Trinidad. From there, we visited the serene Chinese Bell Church, a peaceful contrast to the busy streets of Baguio. On the afternoon, we visited the Philippine Military Academy, where we gained a deeper understanding of the discipline and values instilled in the cadets.</p>

    <br>

    <p>At night, we go to SM Baguio the later on to the night market. The market is fully loaded with tourist, but we managed to still enjoy the night. We bought pasalubong and devoured some delicious street foods.</p>`,
  };
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Link to="/day5" className="w-full sm:w-auto">
            <motion.div
          ...
          <Link to="/day7" className="w-full sm:w-auto">
            <motion.div
