...
export const BlogPost5 = ({ post }) => {
  ...
  const demoPost = post || {
    ...
    content: `<p>We began our day with a visit to the MMDA (Metropolitan Manila Development Authority), where we learned about how traffic management, disaster response, and urban planning are handled in the metro. It was eye-opening to see the operations center and understand how real-time data and coordination help manage the daily flow of such a busy city.</p>

    <br>
    
    <p>In the afternoon, we visited the LRT administration office, where we were introduced to the operations behind Manila’s train system. One of the highlights was getting the opportunity to ride the train for free—a simple yet exciting experience for many of us. The visit gave us a better appreciation of how public transport systems are managed to serve thousands of commuters every day.</p>`,
  };
