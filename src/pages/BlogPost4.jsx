...
export const BlogPost4 = ({ post }) => {
  ...
  const demoPost = post || {
    ...
    content: `<p>Our morning started with a visit to the Bangko Sentral ng Pilipinas (BSP), where we were introduced to the country's central banking system. We learned about their roles in maintaining economic stability, managing currency production, and safeguarding financial institutions. It was enlightening to see how such a major institution operates behind the scenes to keep the Philippine economy running smoothly.</p>

    <br>
    
    <p>In the afternoon, we headed to Hytec Power Inc., where we explored innovations in technical education and industrial training systems. The facility showcased advanced tools and simulators used for engineering and technology training. Seeing the connection between education and hands-on application gave us a deeper appreciation of how industries prepare the workforce for real-world challenges.</p>`,
  };
