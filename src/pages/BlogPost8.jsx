...
import img1 from "../assets/day8/1.jpg";
import img2 from "../assets/day8/2.jpg";
import img3 from "../assets/day8/3.jpg";
import img4 from "../assets/day8/4.jpg";
import img5 from "../assets/day8/5.jpg";
import { BlogNav } from "../components/BlogNav";

export const BlogPost8 = ({ post }) => {
  ...
  const demoPost = post || {
    ...
    content: `<p>After spending seven incredible days with my friends, I realized there's always a reason to stay happy, no matter the circumstances. From late-night walks to 7/11 to saying our goodbyes—not because we wouldn't see each other again, but because we could never be together in the same way again—every moment was special.</p>

    <br>
    
    <p>As I boarded my flight home, I wasn't just carrying luggage filled with dirty clothes, but the memories, laughter, and unforgettable moments we shared during the tour. Thank you, Mamang and Papang, for making this experience possible.</p>`,
  };
